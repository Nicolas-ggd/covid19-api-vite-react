    ...
    return (
        <section className={`bg-grey-50 ${themeClass}`}>
            {!isSend && !isSuccessSend && <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                ...
                {isNotified && <Notification onClose={() => setIsNotified(false)} message="You have registered, now you need verify your account, verification link is send your email" condition="success" />}
            </div>}
