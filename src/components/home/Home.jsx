  ...
  return (
    <div className="w-full h-full bg-grey-50 dark:bg-gray-800">
      ...
      <div className="mx-10 mt-10 flex justify-between">
        ...
        <div className="my-20 w-full h-screen relative overflow-x-auto shadow-md sm:rounded-lg">
          ...
          {!isLoading && <table className="w-full h-screen text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          {!isLoading && (
            <div className="dark:bg-gray-800 flex pt-6 justify-end">
