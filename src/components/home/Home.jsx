  ...
  return (
    <div className={`w-full h-full bg-grey-50 ${themeClass}`}>
      ...
      <div className="px-10 flex justify-between">
        <div className="pt-10">
          {isUserList && <div className={`max-w-sm p-6 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ${isDarkMode ? 'bg-grey-800 border-gray-700' : 'bg-white'}`}>
